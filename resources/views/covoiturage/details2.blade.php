              ...
              <div class="panel-body">
                    <div class="row">
                         ...
                         <p>
                             ...
                             <span class="label label-success" data-toggle="tooltip" data-placement="top" title="Je conduis en musique" data-animation="false">Musique</span>
                             @else
                             <span class="label label-default" data-toggle="tooltip" data-placement="top" title="Je n'aime pas la musique">Musique</span>
                             @endif
                             @if($conducteur->pref_animeaux == 1)
                             <span class="label label-success" data-toggle="tooltip" data-placement="top" title="Tooltip on top">Animaux</span>
                             @else
                             <span class="label label-default" data-toggle="tooltip" data-placement="top" title="Tooltip on top">Animaux</span>
                             @endif
                             @if($conducteur->pref_discussion == 1)
                             <span class="label label-success" data-toggle="tooltip" data-placement="top" title="Tooltip on top">Discussion</span>
                             @else
                             <span class="label label-default" data-toggle="tooltip" data-placement="top" title="Tooltip on top">Discussion</span>
                             @endif
                             @if($conducteur->pref_fumeur == 1)
                             <span class="label label-success" data-toggle="tooltip" data-placement="top" title="Tooltip on top">Fumeur</span>
                             @else
                             <span class="label label-default" data-toggle="tooltip" data-placement="top" title="Tooltip on top">Fumeur</span>
                             @endif
                         </p>
                         </div>
                    </div>
